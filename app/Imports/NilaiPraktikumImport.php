...
class NilaiPraktikumImport implements ToCollection, WithStartRow
{
    ...
    public function __construct()
    {
        ...
        $this->percentageQuiz = (int)$request['quiz'] / 100;
        $this->percentageLaporan = (int)$request['laporan'] / 100;
        $this->percentageResponsi = (int)$request['responsi'] / 100;
    }
    ...
    public function collection(Collection $rows)
    {
        ...
        foreach ($rows as $row) {
            ...
            $calculateNilaiAkhir = ($row[4]*$this->percentageQuiz)+($row[5]*$this->percentageLaporan)+($row[6]*$this->percentageResponsi);
