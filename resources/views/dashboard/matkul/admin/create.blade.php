...
@section('container')
    ...
    <div class="col-lg-8 mt-3">
        <form method="post" action="/dashboard/settingmatakuliah" class="mb-5" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('kodematkul') is-invalid @enderror" id="kodematkul"
                    name="kodematkul" required autofocus value="{{ old('kodematkul') }}">
                @error('kodematkul')
            ...
            <div class="mb-3">
                <label for="namamatkul" class="form-label @error('namamatkul') is-invalid @enderror">Nama Mata
                    Kuliah</label>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="blok" id="blok" value="{{ old('blok') }}">
                @error('blok')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                <label for="tahun_ajaran" class="form-label @error('tahun_ajaran') is-invalid @enderror">Tahun
                    Ajaran</label>
