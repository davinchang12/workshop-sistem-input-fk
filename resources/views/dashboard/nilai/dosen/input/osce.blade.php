    ...
    <form action="/dashboard/nilailain/input-osce-submit" method="post">
        ...
        <div class="container mt-3 mb-3 w-75">
            <table cellspacing="0" border="0">
                <tr>
                <td colspan=9   align="center" valign=middle><p class=MsoNormal align=center style='margin-bottom:0in;text-align:center;
                    line-height:normal'><b><span
                    style='font-size:14.0pt'>Lembar Penilaian OSCE</span></b></p></td>
                </tr>
                        <tr>
                <td colspan=9 align="center" valign=middle><p class=MsoNormal align=center style='margin-bottom:0in;text-align:center;
                    line-height:normal'><b><span
                    style='font-size:14.0pt'>{{ $osces[0]->namaosce }}</span></b></p></td>
                </tr>
                <tr>
                ...
                <td style="border : 1px solid black" colspan = 2 rowspan=2 align="center" valign=middle><b>Aspek yang Dinilai</b></td>
                <td style="border : 1px solid black" rowspan=2 align="center" valign=middle><b>Bobot</b></td>
                <td style="border : 1px solid black" colspan=3 rowspawn=2 align="center" valign=middle><b>Nilai<br>0-2</b></td>
                <td style="border : 1px solid black" rowspan=2 align="center" valign=middle><b>TOTAL<br> BOBOT X SKOR</b></td>
                        </tr>
                        <tr>
