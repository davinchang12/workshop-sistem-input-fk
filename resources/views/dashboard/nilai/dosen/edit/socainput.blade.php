...
<body>
    <form action="/dashboard/nilailain/edit/soca/simpan" method="post">
        @csrf
            ...
            <div class=WordSection1>
                ...
                <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=100%
                    ...
                    <tr style='height:20.85pt'>
                        ...
                        <td width=82 style='width:61.55pt;border-top:none;border-left:none;
                            ...
                            <p class=MsoNormal align=center style='margin-bottom:0in;text-align:center;
                                  line-height:normal'><input type="number" name="overview_masalah"
                                    ...
                                    onchange="calculateOverviewMasalah()" value="{{ $socas->where('keterangan_soca', 'Overview Masalah')->first()->skor_soca }}"></p>
                        </td>
                        <td width=66 style='width:49.5pt;border-top:none;border-left:none;border-bottom:
                                  solid black 1.0pt;border-right:solid black 1.0pt;padding:.75pt 4.9pt 0in 4.9pt;
                                  height:20.85pt'>
                        ...
                        <td width=126 valign=bottom style='width:94.7pt;border-top:none;border-left:
                            ...
                            <p class="MsoNormal" id="overview_masalah_total" align=center style='margin-bottom:0in;text-align:center;
                                  line-height:normal'>{{ $socas->where('keterangan_soca', 'Overview Masalah')->first()->skor_soca * $socas->where('keterangan_soca', 'Overview Masalah')->first()->bobot }}</p>
                        </td>
                    </tr>
                    <tr style='height:15.75pt'>
                        ...
                        <td width=82 style='width:61.55pt;border-top:none;border-left:none;
                            ...
                            <p class=MsoNormal align=center style='margin-bottom:0in;text-align:center;
                                  line-height:normal'><input type="number" name="analisis_masalah"
                                    ...
                                    style="border: none; font-size:18px; width:100%; text-align: center;"
                                    onchange="calculateAnalisisMasalah()" value="{{ $socas->where('keterangan_soca', 'Analisis Masalah')->first()->skor_soca }}"></p>
                        </td>
                        <td width=66 style='width:49.5pt;border-top:none;border-left:none;border-bottom:
                                  solid black 1.0pt;border-right:solid black 1.0pt;padding:.75pt 4.9pt 0in 4.9pt;
                                  height:15.75pt'>
                        ...
                        <td width=126 valign=bottom style='width:94.7pt;border-top:none;border-left:
                            ...
                            <p class=MsoNormal id="analisis_masalah_total" align=center style='margin-bottom:0in;text-align:center;
                                  line-height:normal'>{{ $socas->where('keterangan_soca', 'Analisis Masalah')->first()->skor_soca * $socas->where('keterangan_soca', 'Analisis Masalah')->first()->bobot }}</p>
                        </td>
                    </tr>
                    <tr style='height:.6in'>
                    ...
                    @foreach ($socas_2 as $soca)
                        @php
                            array_push($jenis_aspek, str_replace(' ', '_', strtolower($soca->keterangan_soca)));
                        @endphp
                                ...
                                <p class=MsoNormal align=center style='margin-bottom:0in;text-align:center;
                                  line-height:normal'>
                                    <input type="number"
                                        ...
                                        onchange="calculateKemampuanPengaplikasian({{ str_replace(' ', '_', strtolower($soca->keterangan_soca)) }})" value="{{ $soca->skor_soca }}">
                                </p>
                            </td>
                            <td width=66 style='width:49.5pt;border-top:none;border-left:none;border-bottom:
                                  solid black 1.0pt;border-right:solid black 1.0pt;padding:.75pt 4.9pt 0in 4.9pt;
                    ...
                    <tr style='height:14.55pt'>
                        ...
                        <td width=148 colspan=2 style='width:111.05pt;border-top:none;border-left:
                            ...
                            <select name="sikap_keterangan" id="sikap_keterangan"
                                ...
                                <option value="memuaskan" title="Memuaskan" {{ $socas_3[0]->kepuasan_presentasi == "memuaskan" ? "selected" : "" }}>Memuaskan</option>
                                <option value="tidak_memuaskan" title="Tidak Memuaskan" {{ $socas_3[0]->kepuasan_presentasi == "tidak_memuaskan" ? "selected" : "" }}>Tidak Memuaskan</option>
                            </select>
                        </td>
                        <td width=126 style='width:94.7pt;border-top:none;border-left:none;
                                  border-bottom:solid black 1.0pt;border-right:solid black 1.0pt;
                            ...
                            <input type="text" name="sikap_komentar" id="sikap_komentar" max="10" min="0"
                                style="border: none; font-size:18px; width:100%;" value="{{ $socas_3[0]->komentar }}">
                        </td>
                    </tr>
                    <tr style='height:14.55pt'>
                        <td width=374 style='width:280.75pt;border-top:none;border-left:none;
                        ...
                        <td width=148 colspan=2 style='width:111.05pt;border-top:none;border-left:
                            ...
                            <select name="kemampuan_berkomunikasi_keterangan" id="kemampuan_berkomunikasi_keterangan"
                                style="border:none; width:100%; font-size:18px; text-align:center;" required>
                                <option value="memuaskan" title="Memuaskan" {{ $socas_3[1]->kepuasan_presentasi == "memuaskan" ? "selected" : "" }}>Memuaskan</option>
                                <option value="tidak_memuaskan" title="Tidak Memuaskan" {{ $socas_3[1]->kepuasan_presentasi == "tidak_memuaskan" ? "selected" : "" }}>Tidak Memuaskan</option>
                            </select>
                        </td>
                        <td width=126 style='width:94.7pt;border-top:none;border-left:none;
                                  border-bottom:solid black 1.0pt;border-right:solid black 1.0pt;
                            ...
                            <input type="text" name="kemampuan_berkomunikasi_komentar"
                                ...
                                style="border: none; font-size:18px; width:100%;" value="{{ $socas_3[1]->komentar }}">
                        </td>
                    </tr>
                    <tr style='height:14.55pt'>
                        <td width=374 style='width:280.75pt;border-top:none;border-left:none;
                        ...
                        <td width=148 colspan=2 style='width:111.05pt;border-top:none;border-left:
                            ...
                            <select name="sistematika_penyajian_keterangan" id="sistematika_penyajian_keterangan"
                                style="border:none; width:100%; font-size:18px; text-align:center;" required>
                                <option value="memuaskan" title="Memuaskan" {{ $socas_3[2]->kepuasan_presentasi == "memuaskan" ? "selected" : "" }}>Memuaskan</option>
                                <option value="tidak_memuaskan" title="Tidak Memuaskan" {{ $socas_3[2]->kepuasan_presentasi == "tidak_memuaskan" ? "selected" : "" }}>Tidak Memuaskan</option>
                            </select>
                        </td>
                        <td width=126 style='width:94.7pt;border-top:none;border-left:none;
                                  border-bottom:solid black 1.0pt;border-right:solid black 1.0pt;
                            ...
                            <input type="text" name="sistematika_penyajian_komentar" id="sistematika_penyajian_komentar"
                                max="10" min="0" style="border: none; font-size:18px; width:100%;" value="{{ $socas_3[2]->komentar }}">
                        </td>
                    </tr>
                    <tr style='height:71.45pt'>
                        <td width=697 colspan=5 valign=top style='width:522.5pt;border:solid black 1.0pt;
                            ...
                            <p class=MsoNormal><span lang=ES>Hasil Penilaian Keterampilan presentasi &amp;
                                    sikap</span></p>
                            <textarea name="hasil_penilaian_keterampilan_presentasi_dan_sikap" id="hasil_penilaian_keterampilan_presentasi_dan_sikap" style="width: 100%">{{ $socas_4[0]->komentar }}</textarea>
                        </td>
                    </tr>
                </table>
    ...
    <script type="text/javascript">
        ...
        var temp_jenis = <?php echo json_encode($jenis_aspek); ?>;

        temp_jenis.forEach(element => {
            jenis_2.push(element);
        });
