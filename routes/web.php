...
Route::post('/dashboard/matkul/nilai/export-praktikum-responsi-remidial', [NilaiPraktikumController::class, 'exportResponsiRemidial']);
Route::post('/dashboard/matkul/nilai/import-praktikum-responsi-remidial', [NilaiPraktikumController::class, 'importResponsiRemidial']);
